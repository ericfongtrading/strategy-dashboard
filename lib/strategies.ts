...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.099,
    status: 'live',
    description: 'Systematic mean reversion on a focused basket of commodity-currency crosses. Fades statistically stretched moves back toward equilibrium, with volatility-scaled stops and a hard time limit on every position. One open position per currency, so correlated exposure cannot stack. Fixed fractional risk per trade; returns are stated net of a 1 pip round-trip cost. The table above covers 2019 onward; the same four-pair basket has been profitable since 2017, positive in every year.',
    ...
    liveStartMonth: 9,
    highlights: [
      '+58.2% over 7.7 years and 635 trades, net of a 1 pip round-trip cost',
      'Positive in every year since 2017, when the four-pair basket begins; the worst full year was +1.4%',
      'Max drawdown 9.9% against ~6% a year, so peak-to-trough is under two years of profit',
