...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.099,
    status: 'live',
    description: 'Systematic mean reversion on a focused basket of commodity-currency crosses. Fades statistically stretched moves back toward equilibrium, with volatility-scaled stops and a hard time limit on every position. One open position per currency, so correlated exposure cannot stack. Fixed fractional risk per trade; returns are stated net of a 1 pip round-trip cost.',
    dataSource: 'Backtest 2013-2026 (13.7 yr) | Live: Sep 2026',
    backtestStart: 2013,
    backtestEnd: 2026,
    liveStart: 2026,
    liveStartMonth: 9,
    highlights: [
      '+97.8% cumulative over 13.7 years and 1,005 trades, net of a 1 pip round-trip cost',
      'Positive in all 14 years; the worst full year was +0.5%',
      'Max drawdown 9.9% against ~7% a year, so peak-to-trough is close to a single year of profit',
      'One open position per currency: the four crosses share currencies, so the rule caps correlated risk at two positions',
      'Runs unattended 24/5 on a VPS against the IB Gateway API, with server-side stops so a disconnect cannot leave a position unprotected',
    ],
    monthlyReturns: [
      { year: 2013, months: [-0.4, 1.7, 1.3, -0.5, -0.8, 0.2, -1.2, 3.1, -0.7, -0.6, 0.8, 0.3], ytd: 3.0 },
      { year: 2014, months: [-2.9, 2.0, 2.2, 0.9, 2.2, 0.8, 1.6, 0.0, -2.0, 2.2, 1.6, 1.4], ytd: 10.1 },
      { year: 2015, months: [0.8, 0.9, 0.2, 1.3, 0.6, 2.3, 2.4, 0.4, 1.4, 0.2, -0.2, 0.0], ytd: 10.3 },
      { year: 2016, months: [0.8, 1.8, 1.8, 0.2, 2.2, 1.5, -0.8, 0.5, 1.4, 1.4, 0.0, 0.6], ytd: 11.3 },
      { year: 2017, months: [-0.5, 1.1, 0.7, -3.4, -2.4, 1.0, 0.9, -1.1, 0.4, 1.1, 3.6, 2.9], ytd: 4.3 },
      { year: 2018, months: [2.0, 2.7, -1.4, 0.3, -1.1, 1.8, 2.6, -3.3, 1.6, -1.6, -1.4, -1.6], ytd: 0.5 },
      { year: 2019, months: [1.6, 1.5, 2.5, 1.3, -1.6, -1.0, -1.4, 3.1, -0.7, -0.5, 1.1, 1.0], ytd: 6.9 },
      { year: 2020, months: [-1.6, 0.2, -0.1, 1.2, 2.6, -1.4, 1.2, 1.3, -4.0, 1.8, 0.1, -0.0], ytd: 1.4 },
      { year: 2021, months: [0.9, 0.9, -2.0, -2.5, 2.5, 2.4, 2.2, -0.6, -1.3, -1.3, 0.6, 0.6], ytd: 2.4 },
      { year: 2022, months: [-1.4, -0.4, -3.4, -0.2, 0.7, 0.4, 3.5, 3.1, -0.3, 0.3, -0.5, -0.1], ytd: 1.7 },
      { year: 2023, months: [-1.4, 2.9, 4.0, -0.3, -0.4, 2.5, 2.9, 0.5, 0.9, 2.8, 2.0, 3.1], ytd: 19.4 },
      { year: 2024, months: [0.9, 0.9, 0.6, -0.8, 0.0, 1.1, -3.8, 3.8, 0.1, 2.6, 2.9, 0.6], ytd: 9.0 },
      { year: 2025, months: [0.5, -1.4, 1.1, 0.7, 2.1, 2.2, 2.6, 3.7, -0.2, -0.0, 1.1, 0.9], ytd: 13.3 },
      { year: 2026, months: [-2.4, -0.2, 2.2, 1.0, 0.3, -0.8, 5.8, -0.5, -1.1, null, null, null], ytd: 4.2, isLive: true },
    ],
  },
  {
    id: 'options',
