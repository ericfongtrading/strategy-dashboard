...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    statusLabel: 'Live',
    extraMetrics: [
      { label: 'LP gain (before hedges)', value: '+$8,424', tone: 'good' },
      { label: 'Net P&L (after hedges)', value: '+$3,861', tone: 'good' },
      { label: 'Initial capital', value: '$200,000', modalOnly: true },
      { label: 'Current value', value: '$208,424', modalOnly: true },
      { label: 'Fees earned', value: '$4,509', modalOnly: true },
      { label: 'Hedge cost', value: '$4,563', modalOnly: true },
    ],
    ...
    dataSource: 'Live since Sep 2026 | updated 2026-09-24',
    highlights: [
      'Net +$3,861 on $200,000 over 20 days = 35.2% annualized, after every hedge gain and loss',
      'Initial capital $200,000 -> current value $208,424: +$8,424 LP gain before hedges, less $4,563 of hedge cost',
      'Swap fees earned $4,509 and compounding at roughly $285/day (about 52%/yr on capital) - the rest of the gain is price movement on unhedged pools',
