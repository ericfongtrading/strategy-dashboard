...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.127,
    status: 'live',
    description: 'Systematic momentum strategy on COMEX gold futures. Trades the Asia/London and US sessions, pyramiding up to 4 positions in a confirmed trend. Total return +170% over 6.6 years with every calendar year positive. Returns quoted as % of 1-contract notional.',
    ...
    monthlyReturns: [
      ...
      { year: 2020, months: [5.6, 10.4, 1.9, 4.4, 3.1, 4.8, 13.3, 2.6, -4.8, -0.8, 0.8, -0.2], ytd: 41.1 },
      { year: 2021, months: [-2.9, 7.7, 1.5, -3.3, 11.6, -3.1, -4.2, -1.8, -1.4, -2.6, 3.1, -1.1], ytd: 3.5 },
      { year: 2022, months: [0.9, 5.9, 2.5, -0.6, 1.8, 1.6, 2.1, 0.2, 3.3, -1.0, -3.1, 5.4], ytd: 19.0 },
      { year: 2023, months: [4.1, -2.6, -1.1, 3.6, 3.7, 0.9, -4.0, -6.9, 8.7, -2.3, 3.8, 9.2], ytd: 17.1 },
      { year: 2024, months: [-6.3, -2.7, 13.0, -0.2, -3.1, 2.2, 0.5, -1.6, 4.7, 2.8, -4.0, 5.8], ytd: 11.1 },
      { year: 2025, months: [4.6, 2.3, 8.0, 8.4, -0.2, 1.5, 7.1, 5.5, 6.2, 0.2, 5.4, -3.4], ytd: 45.6 },
      { year: 2026, months: [22.3, 2.0, -5.2, 2.8, 6.0, 11.0, -0.0, null, null, null, null, null], ytd: 38.9, isLive: true },
    ],
  },
  {
    id: 'nq',
