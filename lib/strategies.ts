...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    statusLabel: 'Live',
    extraMetrics: [
      { label: 'Fees earned', value: '+$2,559', tone: 'good' },
      { label: 'Net P&L', value: '+$3,365', tone: 'good' },
    ...
    highlights: [
      ...
      'Initial capital $200,000 -> current value $205,896; after $2,531 of hedge cost, net P&L +$3,365 since inception',
