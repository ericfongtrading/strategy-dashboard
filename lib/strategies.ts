...
export const strategies: Strategy[] = [
  {
    ...
    additiveEquity: true,
    monthlyNote:
      'Months are month-end. Max drawdown is measured on the daily equity curve, so its peak and trough fall inside months that can show positive returns — the -8.6% ran 25 Feb 2022 to 1 Apr 2022.',
    highlights: [
      'Headline basis is 2022 onward. Over the full 2019-2026 record the same code returns 16.9% CAGR at -21.2% max DD with Sharpe 1.62; 2020 was the only losing year (-3.0%).',
      'Record is modelled on final exchange bars with the exact deployed rules: all five sleeves, the regime filter and the one-entry-per-day rule. Live fills are reconciled against that model after every session.',
      'Worst drawdown -21.2%: peak 22 May 2020, trough 19 Jan 2021, back to a new high 8 Mar 2021 (290 days underwater). On the 2022-onward basis the worst is -8.6%, 25 Feb to 1 Apr 2022.',
    ...
    monthlyReturns: [
      { year: 2022, months: [4.2, 0.8, -6.6, 0.3, 6.1, 2.9, 4.1, -1.9, 3.9, 1.6, 10.1, 0.6], ytd: 26.1 },
      { year: 2023, months: [-1.3, 3.9, 2.1, -0.4, 3.7, 1.9, 2.0, 3.9, -0.2, 1.7, 10.9, 2.9], ytd: 31.1 },
      { year: 2024, months: [-4.2, 6.9, 1.1, 2.7, -1.4, -3.1, 3.4, 3.9, 1.5, 18.4, 7.2, 0.2], ytd: 36.6 },
      { year: 2025, months: [2.6, 7.9, 2.7, -7.5, 1.3, 14.0, 3.1, -5.8, 13.6, 0.1, 0.0, 1.8], ytd: 33.8 },
      { year: 2026, months: [8.6, 15.8, 6.2, -2.0, 4.1, 0.0, -0.1, -3.4, 1.4, null, null, null], ytd: 30.6, isLive: true },
    ],
