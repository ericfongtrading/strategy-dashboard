...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    edge: 'Volatility',
    cagr: '32.5%',
    cagrLabel: 'CAGR · BTC · backtest',
    cagrNum: 0.325,
    sharpe: '5.90',
    maxDD: '-8.0%',
    maxDDNum: 0.08,
    status: 'active',
    description: 'Systematic options premium selling on BTC, governed by a proprietary cycle-phase regime model with two-tier expiry structure. ALL figures are BTC-denominated — pure options alpha, no spot beta. Headline metrics are the current strategy version backtested Mar 2021–May 2026; the monthly table below is the live account record since Jun 2022, deposit-adjusted, spanning all parameterisations — its drawdown (max −17.1%) runs deeper than the current version’s backtest.',
    dataSource: 'Backtest 2021–2026 · Live since Jun 2022 · all figures BTC-denominated',
    backtestStart: 2021,
    backtestEnd: 2026,
    liveStart: 2022,
    highlights: [
      'Backtest (current version, 2021–2026): +32.5% CAGR, max DD −8.0%, 94.8% win rate',
      'Live account (all versions, since Jun 2022): +21.8% CAGR, +130% cumulative, max DD −17.1%',
    ...
    monthlyReturns: [
      ...
      { year: 2026, months: [2.7, 4.0, 3.6, 2.1, 1.8, -0.8, 0.6, -13.8, null, null, null, null], ytd: -1.2, isLive: true },
    ],
  },
  {
    id: 'btc-lsr',
