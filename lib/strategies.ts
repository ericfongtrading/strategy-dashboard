...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Full transparency below: every historical trade, current positions and pending plans, refreshed daily',
      'Paper $100k forward test — sample far too short to draw conclusions yet',
    ],
    monthlyReturns: [
