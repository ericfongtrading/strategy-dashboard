...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.127,
    status: 'live',
    description: 'Systematic momentum strategy on COMEX gold futures. Trades the Asia/London and US sessions, pyramiding up to 4 positions in a confirmed trend, with each position sized 1.5x/0.5x by overnight session direction (live since Sep 2026). Compounded return +704% over 6.6 years with every calendar year positive. Returns are % of base notional, compounded.',
    ...
    monthlyReturns: [
      ...
      { year: 2020, months: [5.0, 15.6, -4.2, 6.2, 3.1, 4.5, 20.8, 0.1, -3.0, 0.3, 2.5, 0.4], ytd: 61.1 },
      { year: 2021, months: [-2.3, 14.4, 1.3, -4.6, 11.4, -3.0, -5.4, -1.1, -0.3, -3.1, 3.1, -2.8], ytd: 5.7 },
      { year: 2022, months: [3.8, 4.7, 4.7, -2.5, 1.6, 2.7, 1.1, 1.7, 2.3, -1.5, -1.8, 6.1], ytd: 25.0 },
      { year: 2023, months: [3.6, -2.0, -0.8, 1.3, 2.5, 0.8, -2.1, -5.4, 11.7, -1.3, 2.9, 13.5], ytd: 25.7 },
      { year: 2024, months: [-6.0, -1.9, 19.5, -4.1, -1.4, 0.8, 1.5, -4.1, 4.4, 3.5, -0.6, 9.6], ytd: 20.3 },
      { year: 2025, months: [8.1, -1.4, 10.5, 5.3, -2.6, 1.8, 5.9, 2.6, 9.2, 6.6, 4.5, -2.3], ytd: 58.8 },
      { year: 2026, months: [28.5, 1.6, -3.3, 5.9, 5.9, 10.9, -1.5, null, null, null, null, null], ytd: 54.7, isLive: true },
    ],
  },
  {
    id: 'nq',
