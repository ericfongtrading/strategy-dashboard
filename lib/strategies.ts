...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.164,
    status: 'live',
    description: 'Bollinger-band mean reversion on five FX crosses (NZDCAD, EURCHF, AUDCAD, GBPAUD, GBPNZD). Fades a close beyond the 20,2 band, targets the middle band, stops at 2.5x ATR with a 24-bar time stop. Risk 0.50% per trade, compounding. Returns are net of measured per-pair spreads (0.2-0.8 pips).',
    dataSource: 'Backtest 2017â2026 (9.4 yr, 3,246 trades) Â· Live: Apr 2026',
    backtestStart: 2017,
    backtestEnd: 2026,
    liveStart: 2026,
    liveStartMonth: 4,
    highlights: [
      '+123.3% cumulative over 9.4 years, 3,246 trades across 5 crosses',
