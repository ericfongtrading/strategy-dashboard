...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    statusLabel: 'Live',
    extraMetrics: [
      { label: 'LP gain (before hedges)', value: '+$5,896', tone: 'good' },
      { label: 'Net P&L (after hedges)', value: '+$3,365', tone: 'good' },
      { label: 'Initial capital', value: '$200,000', modalOnly: true },
      { label: 'Current value', value: '$205,896', modalOnly: true },
      { label: 'Fees earned', value: '$2,559', modalOnly: true },
      { label: 'Hedge cost', value: '$2,531', modalOnly: true },
    ],
    ...
    highlights: [
      ...
      'Initial capital $200,000 -> current value $205,896: +$5,896 LP gain before hedges; after $2,531 of hedge cost, net P&L +$3,365 since inception',
      'Of the gain, $2,559 is swap fees earned; the rest is price movement on unhedged pools, which will not repeat reliably',
