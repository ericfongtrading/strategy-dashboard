...
export const strategies: Strategy[] = [
  {
    ...
    maxDDNum: 0.25,
    status: 'live',
    statusLabel: 'Live · figures theoretical',
    ...
    dataSource: 'Backtest 2022–2026 (4.6 yr, 1,398 trades) · theoretical throughout',
    backtestStart: 2022,
    backtestEnd: 2026,
    liveStart: 2026,
    liveStartMonth: 4,
    highlights: [
      ...
      'Live since Apr 2026, but all figures shown are theoretical: the live period was distorted by execution bugs since fixed, so live fills understate the strategy.',
