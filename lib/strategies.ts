...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.08,
    status: 'active',
    description: 'Systematic options premium selling on BTC, governed by a proprietary cycle-phase regime model with two-tier expiry structure. Headline figures are the current strategy version backtested Mar 2021–May 2026, BTC-denominated (no spot beta). The monthly table below is the live account record since Jun 2022, deposit-adjusted — it includes earlier parameterisations, which is why its drawdown is deeper than the current version’s.',
    dataSource: 'Backtest 2021–2026 · Live since Jun 2022',
    backtestStart: 2021,
    backtestEnd: 2026,
    liveStart: 2022,
    highlights: [
      'Current version backtest: +338% cumulative (BTC), 94.8% win rate, max DD -8.0%',
      'Live account since Jun 2022: +127% BTC-denominated (+21.5% CAGR), +530% in USD terms',
