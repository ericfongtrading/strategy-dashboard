...
export const strategies: Strategy[] = [
  {
    ...
    maxDDNum: 0.25,
    status: 'live',
    statusLabel: 'Live since Apr 2026 · figures backtested',
    description: 'Five-sleeve intraday system on Hang Seng Index futures: order-block context on the 4H chart, VWAP-band breakouts and imbalance-cluster entries on the 1-minute chart, with structural exits. Figures are theoretical (backtest signals at modelled cost), 1 HSI contract at HKD 50/pt, fixed size with no compounding, on a HKD 453,000 capital base. Headline covers 2022 onward; see below for the full-history figures.',
    dataSource: 'Backtest 2022–2026 (4.6 yr, 1,398 trades) · live since Apr 2026; figures shown are backtested',
    backtestStart: 2022,
    backtestEnd: 2026,
    liveStart: 2026,
    liveStartMonth: 4,
    highlights: [
      'Headline basis is 2022 onward. Over the full 2019–2026 record the same code returns 8.1% CAGR at −25% DD with Sharpe 0.77 — 2019–2021 produced approximately nothing.',
      'Live since Apr 2026. Figures shown are backtested throughout — they are what the system would have produced free of execution bugs, which were present in the early live period and have since been fixed.',
      'Walk-forward tested (24m train → 6m trade, re-selected each step): out-of-sample +12,555 pt vs +12,246 for an average config — parameters are not overfitted.',
    ...
    recentTrades: [
      { date: '2026-08-26', direction: 'Long', entry: '25,784', exit: '25,785', pnl: '+HK$50', pnlNum: 50, rMultiple: '+0.0R' },
      { date: '2026-08-24', direction: 'Short', entry: '25,443', exit: '25,493', pnl: '-HK$2,500', pnlNum: -2500, rMultiple: '-1.0R' },
      { date: '2026-08-24', direction: 'Short', entry: '25,589', exit: '25,460', pnl: '+HK$6,450', pnlNum: 6450, rMultiple: '+1.4R' },
      { date: '2026-08-21', direction: 'Long', entry: '25,816', exit: '25,948', pnl: '+HK$6,600', pnlNum: 6600, rMultiple: '+1.5R' },
      { date: '2026-08-20', direction: 'Long', entry: '25,804', exit: '25,714', pnl: '-HK$4,500', pnlNum: -4500, rMultiple: '-1.0R' },
    ],
  },
  {
    id: 'gc',
  ...
  },
  {
    ...
    maxDDNum: 0.093,
    status: 'active',
    description: 'Systematic options premium selling on BTC, governed by a proprietary cycle-phase regime model with two-tier expiry structure. ALL figures are BTC-denominated — pure options alpha, no spot beta. Headline metrics and the monthly table are live performance since Jun 2022, deposit-adjusted (unitized NAV), positions carried per the trading plan; drawdown is stated for the current era (since 2024).',
