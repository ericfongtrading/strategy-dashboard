...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    maxDDNum: 0.021,
    status: 'live',
    description: 'Four sleeves on Micro E-mini Nasdaq-100 futures gated by a daily trend/momentum regime: VWAP mean reversion (long R3 + short R1), CCI AM intraday, R3 re-entry, and TLB bear shorts. Fixed 1 MNQ per sleeve on a $28,540 base (4x margin + 1.5x DD buffer). Executed live on Interactive Brokers and mirrored to FTMO via MT5. Automated order routing, server-side OCA brackets, and daily reconciliation of fills against the model.',
    ...
    liveStartMonth: 9,
    highlights: [
      'Four uncorrelated sleeves gated by a daily trend/momentum regime, so the book runs whichever edge suits the day',
      ...
      'Positive in every year of the 5.7-year test, including the 2022 bear market',
      'Return/MaxDD ratio of 26.5x',
    ],
    monthlyReturns: [
      { year: 2021, months: [0.0, -0.6, 0.3, 0.3, 0.3, -0.2, 0.0, 0.0, 1.0, -0.9, 0.2, 0.5], ytd: 0.9 },
      { year: 2022, months: [1.9, 3.2, -0.1, 0.4, 5.2, 2.4, -0.4, 0.5, 2.1, 2.1, -1.5, 1.6], ytd: 17.4 },
      { year: 2023, months: [-1.2, 0.8, -0.1, 0.4, 0.4, 0.7, -0.7, -0.7, -0.7, 1.3, 0.1, 0.9], ytd: 1.2 },
      { year: 2024, months: [0.5, 0.3, 0.2, -0.4, -0.3, 0.4, 0.5, -0.4, 2.4, 2.8, 0.2, -0.4], ytd: 5.8 },
      { year: 2025, months: [2.0, 1.0, 1.8, 5.6, 0.4, -0.2, -0.5, 0.2, 0.0, 0.5, 1.8, -0.6], ytd: 12.0 },
      { year: 2026, months: [-1.0, 0.8, 6.0, 0.8, 1.9, 4.7, -0.7, 2.7, null, null, null, null], ytd: 15.2, isLive: true },
    ],
  },
  {
    id: 'fx',
