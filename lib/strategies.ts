...
export const strategies: Strategy[] = [
  ...
  },
  {
    ...
    statusLabel: 'Live',
    extraMetrics: [
      { label: 'LP gain (before hedges)', value: '+$7,355', tone: 'good' },
      { label: 'Net P&L (after hedges)', value: '+$2,944', tone: 'good' },
      { label: 'Initial capital', value: '$200,000', modalOnly: true },
      { label: 'Current value', value: '$207,355', modalOnly: true },
      { label: 'Fees earned', value: '$3,678', modalOnly: true },
      { label: 'Hedge cost', value: '$4,411', modalOnly: true },
    ],
    ...
    dataSource: 'Live since Sep 2026 | updated 2026-09-22',
    highlights: [
      'Net +$2,944 on $200,000 over 18 days = 29.9% annualized, after every hedge gain and loss',
      'Initial capital $200,000 -> current value $207,355: +$7,355 LP gain before hedges, less $4,411 of hedge cost',
      'Swap fees earned $3,678 and compounding at roughly $245/day (about 45%/yr on capital) - the rest of the gain is price movement on unhedged pools',
